...
function Home() {
  ...
  useEffect(() => {
    Promise.all([
      api.get<Product[]>("/api/products?sort=rating"),
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {categories.map((cat) => (
            <div
              ...
              className="bg-gray-800 p-6 rounded-xl flex flex-col items-center hover:scale-105 hover:bg-gray-700 transition cursor-pointer"
            >
              <img
                src={`https://placehold.co/120x120/111827/22d3ee?text=${encodeURIComponent(cat.name)}`}
                alt={cat.name}
